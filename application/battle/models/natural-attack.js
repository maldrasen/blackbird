...
// the same interface the attack and damage rolls read from a real weapon and its base record, built from the profile
// an attack ability defines rather than a registered weapon. A profile looks like:
//
...
global.NaturalAttack = function(profile) {
  ...
  return {
    ...
    getDamageRange: () => { return { low:profile.low, high:profile.high }; },
