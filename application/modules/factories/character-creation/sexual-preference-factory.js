global.SexualPreferenceFactory = (function() {
  ...
  // When a trigger adds a preference we adjust the value +/- 10 points.
  //
  ...
  function build(options, triggers) {
    ...
    // Actually... triggers won't include slut by this point...
    // If virgin even a trigger any more?
    ...
    [...triggers].forEach(trigger => {
      ...
      // These personality triggers will need to pull sexual preferences from the archetype instead.
