global.SensationPreferences = (function() {
  ...
  function apply(result, factor) {
    ...
    // We calculate the value and clamp it to the [0.5 - 2] range before sending it to the TrainingMath module.
    // This limits the effect even a strong preference can have on a physical sensation.
    let factorValue = TrainingMath.personalityFactorValue(preferenceValue) * (sensations.factor || 1);
