...
const daggermawNormal = WeaverPackage('cohort.daggermaws.N');
...
const daggermawAmbush = WeaverPackage('cohort.daggermaws.PA');
...
const daggermawSurprised = WeaverPackage('cohort.daggermaws.MA');
...
const roachNormal = WeaverPackage('cohort.roaches.N');
...
const roachAmbush = WeaverPackage('cohort.roaches.PA');
...
const roachSurprised = WeaverPackage('cohort.roaches.MA');
...
const skitterfangNormal = WeaverPackage('cohort.skitterfangs.N');
...
const skitterfangAmbush = WeaverPackage('cohort.skitterfangs.PA');
...
const skitterfangSurprised = WeaverPackage('cohort.skitterfangs.MA');
...
const yeekNormal = WeaverPackage('cohort.yeeks.N');
...
const yeekAmbush = WeaverPackage('cohort.yeeks.PA');
...
const yeekSurprised = WeaverPackage('cohort.yeeks.MA');
