...
Dialog.register(ArchetypeCode.brat, DialogKeys.proposeTraining_Eager, context => {
  const options = [
...
Dialog.register(ArchetypeCode.brat, DialogKeys.proposeTraining_Willing, context => {
  const options = [
...
Dialog.register(ArchetypeCode.brat, DialogKeys.proposeTraining_Reluctant, context => {
  const options = [
...
Dialog.register(ArchetypeCode.brat, DialogKeys.proposeTraining_Unwilling, context => {
  const options = [
