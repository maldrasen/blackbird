...
Dialog.register(ArchitypeCode.koboldDom, DialogKeys.proposeTraining_Eager, context => {
...
Dialog.register(ArchitypeCode.koboldDom, DialogKeys.proposeTraining_Willing, context => {
  return  `{T:name} clicks {T:his} claws together, sizing you up. "Training? You mean sex yes?"`;
});

Dialog.register(ArchitypeCode.koboldDom, DialogKeys.proposeTraining_Reluctant, context => {
  return `{T:name} snorts a puff of hot air. "You have a lot to learn 
    {P:species.name}. Kobolds never ask. We just take."`;
});

Dialog.register(ArchitypeCode.koboldDom, DialogKeys.proposeTraining_Unwilling, context => {
