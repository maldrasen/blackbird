...
Dialog.register(Architype.koboldSub, DialogKeys.proposeTraining_Willing, context => {
  return `{T:name} nods briefly before turning around and lifting {T:his} tail."`;
});

Dialog.register(Architype.koboldSub, DialogKeys.proposeTraining_Reluctant, context => {
  return `{T:name} frowns a little and nods. "If that's what you want from me."`;
});

Dialog.register(Architype.koboldSub, DialogKeys.proposeTraining_Unwilling, context => {
