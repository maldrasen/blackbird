...
Dialog.register(ArchitypeCode.slut, DialogKeys.proposeTraining_Eager, context => {
...
Dialog.register(ArchitypeCode.slut, DialogKeys.proposeTraining_Willing, context => {
  return `{T:name} smiles lazily and stretches. "Sure, I've got nothing better going on.`;
});

Dialog.register(ArchitypeCode.slut, DialogKeys.proposeTraining_Reluctant, context => {
  return `{T:name} raises an eyebrow. "I guess. It's not like I'm going to say no."`; });
Dialog.register(ArchitypeCode.slut, DialogKeys.proposeTraining_Unwilling, context => {
