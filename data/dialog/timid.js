...
Dialog.register(ArchetypeCode.timid, DialogKeys.proposeTraining_Eager, context => {
  const options = [
...
Dialog.register(ArchetypeCode.timid, DialogKeys.proposeTraining_Willing, context => {
...
Dialog.register(ArchetypeCode.timid, DialogKeys.proposeTraining_Reluctant, context => {
  const options = [
...
Dialog.register(ArchetypeCode.timid, DialogKeys.proposeTraining_Unwilling, context => {
  const options = [
