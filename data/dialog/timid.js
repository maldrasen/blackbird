...
Dialog.register(ArchitypeCode.timid, DialogKeys.proposeTraining_Eager, context => {
  const options = [
...
Dialog.register(ArchitypeCode.timid, DialogKeys.proposeTraining_Willing, context => {
...
Dialog.register(ArchitypeCode.timid, DialogKeys.proposeTraining_Reluctant, context => {
  const options = [
...
Dialog.register(ArchitypeCode.timid, DialogKeys.proposeTraining_Unwilling, context => {
  const options = [
