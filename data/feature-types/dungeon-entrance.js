FeatureType.register('dungeon-entrance',{
  build: function() {
    ...
    for (let i = 1; i <= 6; i++) {
      room.setTileContents(4+i, 1, { shadow:true, glyph:{ glyph:'◉', color:DungeonConstants.wallColor, offset:{ x:-0.5, y:-0.5 }}});
      room.setTileContents(4+i, 3, { shadow:true, glyph:{ glyph:'◉', color:DungeonConstants.wallColor, offset:{ x:-0.5, y:0.5 }}});
    }
