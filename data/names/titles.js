...
Name.register('title',Gender.enby,[
  ...
  { name:"Filthy", triggers:['~pervert','ugly']},
  { name:"Fister", triggers:['~savage','sadistic[30]','stretcher[30]']},
  ...
  { name:"Hollering", triggers:['~maniac','stupid']},
  { name:"Jolly", triggers:['~playful']},
  { name:"Nasty", triggers:['~pervert','ugly']},
  { name:"Screaming", triggers:['~maniac','stupid','magical']},
]);
