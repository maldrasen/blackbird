...
##### Next Steps
- Implement Arousal in Sensation Result
- Implement Training Scales in Sensation Result
- Implement Sexual Preferences in Sensation Result
...
A few things had to be put on hold in the sensation calculations as well.
