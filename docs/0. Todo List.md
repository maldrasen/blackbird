...
### Game Status Bar 
I'm was thinking it might be a good idea to have a general game status bar that's almost always visible on the top of the screen. It should display basic information like the current location, time of day, player health, stamina, mana, and arousal. If we have a unified bar like this we won't need to display player information with the partner information in the training screen.
