...
##### Move monsters inward when columns are empty
A bit more complicated than moving forward as it involves moving a lot of characters at once. 
...
The victory screen will be its own mode as we'll need to show loot, experience, etc. Level up events will also be happening in this victory mode I think. The GameOver mode will be easier, just a message and a confirm button that kicks you back to the main menu. Needs to completely reset the game state though.
