...
##### Character Speed
Now that we have character speed calculated, we need to apply it to some actions. Some actions, like defending, probably shouldn't be effected by speed, but maybe it would be better to just apply speed universally so that it's almost always done.
