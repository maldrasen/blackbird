...
---
# Bugs
- When starting a new action we need to check the ongoing persisted actions, removing the ones that will be replaced before we create the sensation result.
