...
##### Turn the commands into records
It doesn't make sense to have some command as records and others as modules. Given that all the commands have an execute() function it should be simple to convert them all to ability records.
