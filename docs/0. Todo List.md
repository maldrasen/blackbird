...
### Consider removing Systems from the ECS
I really like how the components and entities are working, but I find I'm not really getting much use out of the systems at all. I think I might just shift into a more hybrid architecture, combining the View and Controller from MVC with the EC from the ECS. A ECVC if you will. Should be easy to do at this point as the Systems aren't doing much.
