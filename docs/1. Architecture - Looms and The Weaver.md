...
-  `{A:niceName}`,`{A:meanName}` A nice pet name or an insulting name. The name used will depend on the personality archetype of the person using it, unless we have something else that determines pet names.
