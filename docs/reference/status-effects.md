...
### Shock (light blue)
- *Stun* Increase time until next action. Unable to defend.
- *Paralysis* Persists after combat. A paralyzed character can't act or move. You can start training with a paralyzed character to do whatever you want to them.
...
- *Hex* The character is unlucky, having reduced accuracy, lowered resistances.
- *Damned* Will take 4x damage on the next attack. 
### Nature (green)
- *Poison* Poison should have different strengths, causing periodic damage.
- *Toxic* Toxic builds stacks and on reaching a certain level causes massive damage.
- *Infestation* Something is growing inside of them. Chance not to act, reduced dodge. After an hour or so they burst with insects or tentacles or whatever taking damage. Can be cured with magic. Birth event should happen after combat.
