...
---
**Notes (Claude):** Pure documentation, no code — CODE_OF_CONDUCT.md, CONTRIBUTING.md, an AI-use disclaimer covering your Claude usage, and asset credits. Low complexity, moderate writing. Natural pairing with [[101-look-for-a-community]] since both are about taking the project public. 