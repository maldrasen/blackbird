...
---
**Notes (Claude):** A large new system — recommend splitting into: (a) fluid production/volume model (how much cum/piss/milk per character, keyed off species with a small testicle-size factor, plus bladder fill); (b) per-orifice fluid tracking during a scene (how much went where); (c) impregnation, including ambiguous paternity when multiple actors fill the same womb. New component(s) plus hooks in the training loop. Foundational for [[027-lactation]], [[042-all-the-way-though]], and the pregnancy content in [[043-additional-sex-actions-body-part-types]].
