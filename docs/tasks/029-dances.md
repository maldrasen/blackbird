...
---
**Notes (Claude):** Dance sex actions built as follow-ons of a base sensual-dance action (dance→dance transitions), a dancing skill, combat dance abilities (arouse / taunt / enthrall), and assistant dance tasks. Spans training and battle. Depends on [[039-grinding-follow-on-actions]] since dances are constrained by the "dancing in front of" position and most player actions would interrupt them — that follow-on-availability work needs to land first. Includes content (each dance plus the few actions that survive alongside it).
