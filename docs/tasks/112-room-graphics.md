...
I was originally planning on making each wall visible from above (fake single point perspective, vanishing point in center of the room), but I don't think there's any way to make that look good with single tile rooms or single tile wide corridors. Instead we should do the standard north wall fully visible, west wall partially visible, orthogonal perspective. We still only draw within the rom's grid footprint. 
