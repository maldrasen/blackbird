...
describe('AreasOfEffect', function() {
  ...
  describe('get(small)', function() {
    it('catches the neighbors and the facing position from the front rank', function() {
      const area = AreasOfEffect.get('P.0.2','small');
