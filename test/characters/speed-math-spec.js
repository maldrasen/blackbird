describe("SpeedMath", function() {
  ...
  describe("calculateSpeedFactor()", function() {
    ...
    it('big fat milkers', function() {
      ...
      expect(Math.round(1000 * SpeedMath.calculateSpeedFactor(milky))).to.equal(1020);
    });
    ...
    it('huge swinging cow tits', function() {
      ...
      expect(Math.round(1000 * SpeedMath.calculateSpeedFactor(milky))).to.equal(1060);
    });
    ...
    it('big fat giant swinging monster tits', function() {
      ...
      expect(Math.round(1000 * SpeedMath.calculateSpeedFactor(milky))).to.equal(1100);
    });
  });
