describe("Actor Scrutinizers", function() {
  ...
  describe("BreastsScrutinizer", function() {
    it("handles A:has-breasts", function() {
      const horse = CharacterFactory.build({ species:SpeciesCode.equian, gender:Gender.male });
      const elf = CharacterFactory.build({ species:SpeciesCode.elf, gender:Gender.female });
