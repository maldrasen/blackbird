describe("Name", function() {
  ...
  describe("isUnique()", function() {
    it("tests a single name", function() {
      ...
      ActorComponent.create(entity,{ name:"Bob", gender:Gender.male, species:SpeciesCode.human });
    ...
    it("tests a name with a title", function() {
      const entity = Registry.createEntity();
      ActorComponent.create(entity,{ title:"Big Dick", name:"Bob", gender:Gender.male, species:SpeciesCode.human });
    ...
    it("tests a name with a surname", function() {
      const entity = Registry.createEntity();
      ActorComponent.create(entity,{ surname:"Cocksucker", name:"Bob", gender:Gender.male, species:SpeciesCode.human });
